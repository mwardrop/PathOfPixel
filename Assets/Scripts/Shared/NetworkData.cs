...
public struct ItemDropData : IDarkRiftSerializable
{
    public ItemState ItemState;
    public string Scene;

    public ItemDropData(ItemState itemState, string scene)
    {
        ItemState = itemState;
        Scene = scene;
    }
    ...
    public void Deserialize(DeserializeEvent e)
    {
        ItemState = e.Reader.ReadSerializable<ItemState>();
        Scene = e.Reader.ReadString();
    }
...
public struct InventoryUpdateData : IDarkRiftSerializable
{
    public InventoryState InventoryState;
    public int PlayerId;

    public InventoryUpdateData(InventoryState inventoryState, int playerId)
    {
    ...
    public void Deserialize(DeserializeEvent e)
    {
        InventoryState = e.Reader.ReadSerializable<InventoryState>();
